    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
                ...
                @can('is_super_admin')
                <div>
                    <a href="{{ url('/posts/create') }}" class="inline-flex items-center justify-center rounded-lg bg-red-50 px-5 py-2.5 text-sm font-medium text-red-700 hover:bg-red-100 transition">
                        Create Post
                    </a>
                </div>
                @endcan
                ...
                <table class="min-w-full divide-y-2 divide-gray-100 text-sm">
                    <thead class="bg-gray-50 text-left">
                        <tr>
                            ...
                            <th class="whitespace-nowrap px-6 py-4 font-semibold text-gray-900">Slug</th>
                            ...
                            <th class="whitespace-nowrap px-6 py-4 font-semibold text-gray-900">Created By</th>
                            <th class="whitespace-nowrap px-6 py-4 font-semibold text-gray-900 text-center">Actions</th>
                        </tr>
                    </thead>
